...
public abstract class FAScript extends GhidraScript {
    ...
    // -----------------------------------------------------------------------
    // PT -- PLANE_TYPE struct layout (SetupPT field-assignment helper)
    // -----------------------------------------------------------------------
    protected void analyzePT() throws Exception {
    ...
    // -----------------------------------------------------------------------
    // PLT -- PILOT struct layout (stats block gaps 1/3/4 via RE; gap 2 via diff)
    // -----------------------------------------------------------------------
    protected void analyzePLT() throws Exception {
