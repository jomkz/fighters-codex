...
| FA_3.LIB | — | Disk 2 (Red) | `.PIC` Ã—822 (aircraft skin textures, raw), `.INF` Ã—269 (aircraft tech sheets, dcl) |
| FA_4B.LIB | — | Install dir | `.11K` Ã—77, `.5K` Ã—9 |
...
| FA_11B.LIB | — | Disk 2 (Red) | `.CB8` Ã—8, `.11K` Ã—8 |
