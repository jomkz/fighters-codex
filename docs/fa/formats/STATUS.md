...
| [HUD](HUD.md) | ui-overlay | partial | re-static [#54](https://github.com/jomkz/fighters-codex/issues/54) | round-trip (byte-identical) | `fx hud` | `tests/test_hud.cpp` | syn/real | — | `gui/src/editors/hud_editor.cpp` |
...
| [LAY](LAY.md) | 3d | partial | re-static [#54](https://github.com/jomkz/fighters-codex/issues/54) | round-trip (byte-identical) | `fx lay` | `tests/test_pe.cpp`<br>`tests/test_lay.cpp` | syn/real | `fuzz/fuzz_pe.cpp` | `gui/src/editors/lay_editor.cpp` |
