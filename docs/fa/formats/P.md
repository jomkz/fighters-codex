...
The identity block (`0x01`–`0xAF`) is fully mapped and editable via the fx-gui PLT editor.
The stats counters (`0x1F80`–`0x21F7`) are confirmed from RE and displayed by `fx plt dump`
