...
**FA.EXE totals:** 21/24 subsystems complete; 2913/2914 in-scope functions named; 4228/8266 referenced globals resolved.

> **Unclaimed: 660 of 3573 functions (170,299 of 866,332 code bytes, 19%) are in the binary but in no subsystem** — so nothing above measures them. **274 of them already carry a recovered name** (the binary tells us what they are; they are the debt #482 closes to zero). See [#482](https://github.com/jomkz/fighters-codex/issues/482).
...
**Program totals (all binaries):** 28/31 subsystems complete; 6458/6459 in-scope functions named; 6702/11595 referenced globals resolved.
