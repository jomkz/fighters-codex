...
| Input — joystick / serial / modem | `0x494270–0x494BB0`<br>`0x499CF0–0x499F70`<br>`0x49B1D0–0x49D1B0` | 72 named · 2 waived / 74 (100%) | 6 named · 118 waived | [doc](input.md) | ✓ | [#224](https://github.com/jomkz/fighters-codex/issues/224) | complete |
...
| Video decode (FMV/Cobra) | `0x456300–0x45CDA0` | 66 named · 0 waived / 66 (100%) | 0 named · 9 waived | [doc](video-decode.md) | ✓ | [#227](https://github.com/jomkz/fighters-codex/issues/227) | complete |
...
| Cockpit sensors (radar / IR / RWR) | `0x438520–0x4410C0` | 62 named · 0 waived / 62 (100%) | 9 named · 179 waived | [doc](cockpit-sensors.md) | ✓ | [#486](https://github.com/jomkz/fighters-codex/issues/486) | complete |
...
**FA.EXE totals:** 21/24 subsystems complete; 2937/2938 in-scope functions named; 4228/8266 referenced globals resolved.

> **Unclaimed: 636 of 3573 functions (166,608 of 866,332 code bytes, 19%) are in the binary but in no subsystem** — so nothing above measures them. **250 of them already carry a recovered name** (the binary tells us what they are; they are the debt #482 closes to zero). See [#482](https://github.com/jomkz/fighters-codex/issues/482).
...
**Program totals (all binaries):** 28/31 subsystems complete; 6482/6483 in-scope functions named; 6702/11595 referenced globals resolved.
