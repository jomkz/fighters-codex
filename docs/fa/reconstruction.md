...
|---|---|---|---|---|---|---|---|
| Object / entity system & shape selection | `0x462600–0x464660`<br>`0x4A6EB0–0x4A7240`<br>`0x473A40–0x473DA0`<br>`0x491240–0x491AA0` | 157 named · 0 waived / 157 (100%) | 31 named · 174 waived | [doc](objects.md) | ✓ | [#210](https://github.com/jomkz/fighters-codex/issues/210) | complete |
| Renderer & rasterizer (GG/G_) | `0x45DBD0–0x45E460`<br>`0x497330–0x499380`<br>`0x4B7900–0x4BA700` | 251 named · 12 waived / 263 (100%) | 14 named · 289 waived | [doc](renderer.md) | ✓ | [#211](https://github.com/jomkz/fighters-codex/issues/211) | complete |
| Flight model / physics (FM/HARD) | `0x451480–0x454800` | 116 named · 4 waived / 120 (100%) | 0 named · 334 waived | [doc](physics.md) | ✓ | [#212](https://github.com/jomkz/fighters-codex/issues/212) | complete |
...
| AI interpreter (CT) | `0x464C60–0x467110` | 130 named · 0 waived / 130 (100%) | 8 named · 30 waived | [doc](ai-interpreter.md) | ✓ | [#216](https://github.com/jomkz/fighters-codex/issues/216) | complete |
...
| Memory & resource managers (MM/RM) | `0x435C60–0x43631C`<br>`0x4A67F0–0x4A6E46` | 86 named · 8 waived / 94 (100%) | 12 named · 36 waived | [doc](memory-resource.md) | ✓ | [#223](https://github.com/jomkz/fighters-codex/issues/223) | complete |
| Input — joystick / serial / modem | `0x494270–0x494BB0`<br>`0x499CF0–0x499F70`<br>`0x49B1D0–0x49D1B0` | 80 named · 2 waived / 82 (100%) | 6 named · 118 waived | [doc](input.md) | ✓ | [#224](https://github.com/jomkz/fighters-codex/issues/224) | complete |
| Core shell / menu / dialog UI | `0x40B8A0–0x40BA10`<br>`0x40BC20–0x40C290`<br>`0x40C410–0x40D7A0`<br>`0x42E680–0x42E720`<br>`0x42E9A0–0x42F2E0`<br>`0x432F80–0x432F8B`<br>`0x433170–0x433180`<br>`0x47F0B0–0x47F100`<br>`0x47FA30–0x47FA50`<br>`0x487A3A–0x489170`<br>`0x4891A0–0x48D2B0`<br>`0x4A08A0–0x4A0FE0`<br>`0x4A26F0–0x4A2A30` | 199 named · 0 waived / 199 (100%) | 43 named · 404 waived | [doc](shell-ui.md) | ✓ | [#225](https://github.com/jomkz/fighters-codex/issues/225) | complete |
| Startup / Phar Lap DOS extender / config | `0x4D715A–0x4E8A2F` | 495 named · 130 waived / 625 (100%) | 40 named · 216 waived | [doc](startup.md) | ✓ | [#226](https://github.com/jomkz/fighters-codex/issues/226) | complete |
| Video decode (FMV/Cobra) | `0x456300–0x45CDA0` | 82 named · 5 waived / 87 (100%) | 0 named · 9 waived | [doc](video-decode.md) | ✓ | [#227](https://github.com/jomkz/fighters-codex/issues/227) | complete |
...
| Cockpit sensors (radar / IR / RWR) | `0x438520–0x4410C0` | 63 named · 0 waived / 63 (100%) | 9 named · 179 waived | [doc](cockpit-sensors.md) | ✓ | [#486](https://github.com/jomkz/fighters-codex/issues/486) | complete |
...
| Airports / carriers — parking, approach, deck (AP) | `0x4BA7E0–0x4BAD40`<br>`0x4BD2D0–0x4BD510`<br>`0x4BE6A0–0x4BEE60` | 26 named · 0 waived / 26 (100%) | 0 named · 0 waived | [doc](airports.md) | · | [#493](https://github.com/jomkz/fighters-codex/issues/493) | active |
| Core math & runtime utility library | `0x411950–0x412DE2` | 64 named · 0 waived / 64 (100%) | 0 named · 0 waived | [doc](core-math.md) | · | [#482](https://github.com/jomkz/fighters-codex/issues/482) | active |

**FA.EXE totals:** 21/25 subsystems complete; 3187/3188 in-scope functions named; 4228/8266 referenced globals resolved.

> **Unclaimed: 386 of 3573 functions (113,377 of 866,332 code bytes, 13%) are in the binary but in no subsystem** — so nothing above measures them. **0 of them already carry a recovered name** (the binary tells us what they are; they are the debt #482 closes to zero). See [#482](https://github.com/jomkz/fighters-codex/issues/482).
...
**Program totals (all binaries):** 28/32 subsystems complete; 6732/6733 in-scope functions named; 6702/11595 referenced globals resolved.
