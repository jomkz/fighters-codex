...
**FA.EXE totals:** 21/25 subsystems complete; 3081/3091 in-scope functions named; 4228/8266 referenced globals resolved.

> **Unclaimed: 492 of 3573 functions (133,124 of 866,332 code bytes, 15%) are in the binary but in no subsystem** — so nothing above measures them. **106 of them already carry a recovered name** (the binary tells us what they are; they are the debt #482 closes to zero). See [#482](https://github.com/jomkz/fighters-codex/issues/482).
...
**Program totals (all binaries):** 28/32 subsystems complete; 6626/6636 in-scope functions named; 6702/11595 referenced globals resolved.
