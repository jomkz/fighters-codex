...
|---|---|---|---|---|---|---|---|
| Object / entity system & shape selection | `0x462600–0x464660`<br>`0x4A6EB0–0x4A7240`<br>`0x473A40–0x473DA0`<br>`0x491240–0x491AA0` | 102 named · 0 waived / 102 (100%) | 29 named · 169 waived | [doc](objects.md) | ✓ | [#210](https://github.com/jomkz/fighters-codex/issues/210) | complete |
| Renderer & rasterizer (GG/G_) | `0x45DBD0–0x45E460`<br>`0x497330–0x499380`<br>`0x4B7900–0x4BA700` | 156 named · 7 waived / 163 (100%) | 6 named · 168 waived | [doc](renderer.md) | ✓ | [#211](https://github.com/jomkz/fighters-codex/issues/211) | complete |
...
| Input — joystick / serial / modem | `0x494270–0x494BB0`<br>`0x499CF0–0x499F70`<br>`0x49B1D0–0x49D1B0` | 35 named · 2 waived / 37 (100%) | 1 named · 66 waived | [doc](input.md) | ✓ | [#224](https://github.com/jomkz/fighters-codex/issues/224) | complete |
...
| Startup / Phar Lap DOS extender / config | `0x4D715A–0x4E8A2F` | 465 named · 116 waived / 581 (100%) | 40 named · 175 waived | [doc](startup.md) | ✓ | [#226](https://github.com/jomkz/fighters-codex/issues/226) | complete |
| Video decode (FMV/Cobra) | `0x456300–0x45CDA0` | 30 named · 0 waived / 30 (100%) | 0 named · 0 waived | [doc](video-decode.md) | ✓ | [#227](https://github.com/jomkz/fighters-codex/issues/227) | complete |
...
**FA.EXE totals:** 20/20 subsystems complete; 2188/2188 in-scope functions named; 2640/4949 referenced globals resolved.

> **Unclaimed: 1312 of 3500 functions (397,654 of 852,583 code bytes, 46%) are in the binary but in no subsystem** — so nothing above measures them. See [#482](https://github.com/jomkz/fighters-codex/issues/482).

> **Undefined: 76,657 more executable bytes are in no function at all** — code auto-analysis never reached (typically entered only through a function pointer: window procs, thread entries, proc-table entries, callbacks), so it was labelled but never disassembled. It is absent from the counts above, because a function that does not exist cannot be reported missing. **257 symbol names already sit inside these bytes** — those are free to claim. See [#496](https://github.com/jomkz/fighters-codex/issues/496).
...
**Program totals (all binaries):** 27/27 subsystems complete; 4960/4960 in-scope functions named; 5114/8278 referenced globals resolved.
